...
public class Register extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		ap.getChildren().addAll(title,Account,Pwd,Idf,Accounttextfield,identifytextfield,passwordfield,rgsbutton,imageView);
		...
		primaryStage.getIcons().add(new Image("file:/D:/sp111/spds/smms/src/main/java/com/xftxyz/smms/view/register.png"));
