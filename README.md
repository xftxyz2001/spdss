...
| 6√   | 7月29日早午9：00 | 作业最终完成演示2    |

## 协作分工
| 子项目\\成员                 | 庞晓宇             | 李晨阳                 | 陈罗星        | 李小刚 | 聂嵘康 |
| ---------------------------- | ------------------ | ---------------------- | ------------- | ------ | ------ |
| 需求分析                     | 协助               | 协助                   | 主要负责      |
| 第一次汇报                   |                    |                        | PPT制作、汇报 |
| 原型设计                     | 界面、功能         | 数据库                 | 协助          | 协助   |
| 数据库设计（SQL）            | 初步设计、SQL编写  | 优化设计               | 协助          | 协助   |
| 数据层（实体、DAO）          | 设计、编码         | 协助                   | 协助          | 协助   |
| 第二次汇报                   | 协助               | 协助                   | PPT制作、汇报 |
| 服务层（连接视图层和数据层） | 设计、编码         | 协助                   |
| 视图层（界面）               | 控件功能实现       | 优化布局、提升用户体验 |
| 测试                         | 测试文档、问题修复 | 协助                   | 协助          |
| 最终汇报                     | 协助               | 协助                   | PPT制作、汇报 |
